...
// Constructors
Server::Server() : _epoll_fd(-1), _configFile(""), _socketFd(-1), _port(0), _host(""), _root(""), _index(""), _cgi(""), _upload(""), _clientMaxBodySize(""),  _allowMethods(std::list<std::string>()), _errorPages(std::map<size_t, std::string>()) {
